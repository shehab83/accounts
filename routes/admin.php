...
use App\Http\Controllers\Admin\supermarketControllrt;
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
 ...
 Route::get('/supermarket/index', [supermarketControllrt::class, 'index'])->name('admin.supermarket.index');
 Route::get('/supermarket/index/search', [supermarketControllrt::class, 'SearchProductBarcode'])->name('admin.supermarket.barcode.search');
...
Route::get('profile', [ProfileController::class,'index'])->name('admin.profile.show');
