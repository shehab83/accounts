...
$("#sales_item_type_mainUpdate").prop('disabled', true)
      ...
      jQuery.ajax({
        ...
        data: {
          ...
          total_befor_discount: total_befor_discount,sales_item_type:sales_item_type_mainUpdate,
  ...
  $(document).on('change', '#sales_item_type_mainUpdate', function (e) {
    if (!$(".remove_active_row_item").length) {
        var sales_item_type_partit=$(this).val();
        $("#sales_item_type").val(sales_item_type_partit);
    }
    recalcualte();
