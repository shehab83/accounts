...
class Inv_itemCard extends Model
{
    ...
    protected $fillable=[
    'item_type','name','inv_itemcard_categories_id','product_code','parent_inv_itemcard_id','does_has_retailunit','retail_uom','uom_id','retail_uom_quntToParent','created_at','updated_at','added_by','updated_by','com_code','active','date','item_code','barcode',
