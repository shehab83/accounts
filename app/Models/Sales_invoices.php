        ...
        'is_approved', 'com_code', 'notes', 'discount_type', 'discount_percent',
         'discount_value', 'tax_percent', 'total_cost_items', 'tax_value', 'total_befor_discount',
          'total_cost', 'account_number', 'money_for_account', 'pill_type', 'what_paid', 'what_remain',
           'treasuries_transactions_id', 'customer_balance_befor', 'customer_balance_after', 'added_by','delegate_commision_value',
           'delegate_commision_percent','delegate_commission_percent_type',
            'created_at', 'updated_at', 'updated_by', 'approved_by','is_has_customer','delegate_code','date','sales_item_type'
        ];
}
