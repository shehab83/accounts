...
class ItemcardBalanceController extends Controller
{
    public function index()
    {
        ...
        $allitemscardData = get_cols_where_p(new Inv_itemCard(), array("id", "name", "item_code", "item_type", "does_has_retailunit", "retail_uom_id", "uom_id", "retail_uom_quntToParent","All_QUENTITY"), array("com_code" => $com_code), "All_QUENTITY", "DESC", PAGINATION_COUNT);
