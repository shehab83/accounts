                                ...
                                if ($datainsert_items['batch_auto_serial'] == "") {
                                    if ($datainsert_items['sales_item_type'] == 2) {
                                        $batch_data = get_cols_where_row(
                                            ...
                                            array(
                                                "com_code" => $com_code, "auto_serial" => $request->inv_itemcard_batches_autoserial,
                                    ...
                                    $batch_data = get_cols_where_row(
                                        ...
                                        array("quantity", "unit_cost_price", "id"),
                                        array(
                                            "com_code" => $com_code, "auto_serial" => $datainsert_items['batch_auto_serial'],
                                            'store_id' => $request->store_id, 'item_code' => $request->item_code
                                        )
                                    );
                                    if (!empty($batch_data)) {
                ...
                if ($invoice_data['is_approved'] == 0) {
                    ...
                    if ($flag) {
                        ...
                        if ($invoice_data['is_has_customer'] == 1) {
                            ...
                            refresh_account_blance_customer($customerData["account_number"], new Account(), new Customer(), new Treasuries_transactions(), new SalesReturn(),new services_with_orders(), false);
                        }
                        echo json_encode("done");
                    }
                }
