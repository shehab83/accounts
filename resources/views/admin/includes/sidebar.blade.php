        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            حسابات الموردين
             ...
             <li class="nav-item has-treeview {{ (request()->is('admin/suppliers_orders*') ||request()->is('admin/suppliers_orders_general_return*') ||request()->is('admin/itemcardBalance*') ||request()->is('admin/stores_inventory*') ||request()->is('admin/inv_stores_transfer*') ||request()->is('admin/inv_stores_transfer_incoming*') )?'menu-open':'' }}     ">
                ...
                <ul class="nav nav-treeview">
                   ...
                   @can('أومر التحويل صادرة بين المخازن')
                   <li class="nav-item">
             ...
             أوامر تحويل مخزنية صادرة
                 ...
                 @endcan
                 @can('أومر التحويل الواردة بين المخازن')
                 <li class="nav-item">
             ...
             <li class="nav-item has-treeview  {{ (request()->is('admin/inv_production_order*')  || request()->is('admin/inv_production_lines*') || request()->is('admin/inv_production_exchange*')  ||request()->is('admin/inv_production_Receive*'))?'menu-open':'' }}    ">
              ...
              <li class="nav-item has-treeview {{ (request()->is('admin/SalesInvoices*') || request()->is('admin/SalesReturnInvoices*')|| request()->is('admin/supermarket*'))?'menu-open':'' }}     ">
                <a href="#" class="nav-link {{ (request()->is('admin/SalesInvoices*') || request()->is('admin/SalesReturnInvoices*')|| request()->is('admin/supermarket*') )?'active':'' }}">
                   <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                المبيعات
                    <i class="right fas fa-angle-left"></i>
         ...
         فواتير المبيعات
          ...
          مرتجع المبيعات العام
                  ...
                  {{-- <li class="nav-item">
                    <a href="{{ route('admin.supermarket.index') }}" class="nav-link {{ (request()->is('admin/supermarket*') )?'active':'' }}">
          ...
          شفتات الخزن
              ...
              <li class="nav-item has-treeview {{ (request()->is('admin/admins_accounts*') || request()->is('admin/roles*') )?'menu-open':'' }}  ">
                <a href="#" class="nav-link {{ (request()->is('admin/admins_accounts*') || request()->is('admin/roles*') )?'active':'' }}">
                   <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                     الصلاحيات
                    <i class="right fas fa-angle-left"></i>
