   ...
   <div class="col-12">
      <div class="card">
         <div class="card-header">
            <h3 class="card-title card_title_center"> اضافة  فاتورة استلام  انتاج تام من خط إنتاج </h3>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
            <form action="{{ route('admin.inv_production_Receive.store') }}" method="post" >
               @csrf
               ...
               <div class="form-group">
                  ...
                  <select name="store_id" id="store_id" class="form-control select2">
                     <option value=""> اختر   مخزن استلام الانتاج</option>
