   ...
   <div class="col-12">
      <div class="card">
         <div class="card-header">
            <h3 class="card-title card_title_center">تفاصيل فاتورة استلام انتاج تام من خط الانتاج (الورش)  </h3>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
            ...
            <div class="card-header">
               ...
               <input type="hidden" id="ajax_get_item_uoms_url" value="{{ route('admin.inv_production_Receive.get_item_uoms') }}">
               <input type="hidden" id="ajax_add_new_details" value="{{ route('admin.inv_production_Receive.add_new_details') }}">
               <input type="hidden" id="ajax_reload_itemsdetials" value="{{ route('admin.inv_production_Receive.reload_itemsdetials') }}">
               <input type="hidden" id="ajax_reload_parent_pill" value="{{ route('admin.inv_production_Receive.reload_parent_pill') }}">
               <input type="hidden" id="ajax_load_edit_item_details" value="{{ route('admin.inv_production_Receive.load_edit_item_details') }}">
               <input type="hidden" id="ajax_load_modal_add_details" value="{{ route('admin.inv_production_Receive.load_modal_add_details') }}">
               <input type="hidden" id="ajax_edit_item_details" value="{{ route('admin.inv_production_Receive.edit_item_details') }}">
               <input type="hidden" id="ajax_load_modal_approve_invoice" value="{{ route('admin.inv_production_Receive.load_modal_approve_invoice') }}">
               <input type="hidden" id="ajax_load_usershiftDiv" value="{{ route('admin.inv_production_Receive.load_usershiftDiv') }}">
               <input type="hidden" id="ajax_get_item_batches" value="{{ route('admin.inv_production_Receive.get_item_batches') }}">
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           @if($data['is_approved']==0)
                           <a href="{{ route('admin.inv_production_Receive.delete_details',["id"=>$info->id,"id_parent"=>$data['id']]) }}" class="btn btn-sm are_you_shue   btn-danger">حذف</a>
                           @endif
                        </td>
                     </tr>
                     @php
