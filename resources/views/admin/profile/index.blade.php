...
<a href="{{ route('admin.profile.show') }}"> الملف الشخصي </a>
@endsection
        ...
        <section style="background-color: #eee;">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('admin.profile.update',$information->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">اسم</p>
