...
<html>
   <head>
      ...
      <title> طباعة  كشف حساب المندوب </title>
   ...
   <body style="padding-top: 10px;font-family: tahoma;">
      ...
      <table style="width: 30%;float: right;  margin-right: 5px;" dir="rtl">
         ...
         <tr>
            <td style="text-align: center;padding: 5px;font-weight: bold;">  <span style=" display: inline-block;
               ...
               تقرير خدمات داخلية وخارجية من  ({{ $data['from_date'] }} الي  {{   $data['to_date'] }})
               </span>
            </td>
         </tr>
         <tr>
      ...
      <table  dir="rtl" border="1" style="width: 98%; margin: 0 auto;"  id="example2" cellpadding="1" cellspacing="0"  aria-describedby="example2_info" >
         <tr>
            <td style="width: 25%; text-align: right; font-weight: bold">رقم الحساب المالي المندوب</td>
         ...
         <tr>
            <td style="width: 25%; text-align: right; font-weight: bold">    فواتير خدمات قدمناها   المندوب</td>
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
               عدد  ({{ $data['ServicesForotherCounter']*1 }}) فاتورة خدمات قدمناها المندوب   بقيمة ({{ $data['ServicesForothermoney']*1 }}) جنيه
            </td>
         </tr>
...
<!--  حركة الخدمات-->
<h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold">   حركة الخدمات الداخلية والخارجية علي حساب  المندوب خلال الفترة</h3>


@if (@isset($details['services_orders']) && !@empty($details['services_orders']) && count($details['services_orders'])>0)
@if($data['Does_show_items']==2)
...
@endif
      ...
      <table dir="rtl"  style="width: 98%; margin: 0 auto;"  id="example2" cellpadding="1" cellspacing="0"  aria-describedby="example2_info" >
        <tr >
            <td style="font-weight: bold;">التوقيع:................:Signature</td>
            <td style="font-weight: bold;">توقيع المستلم:................:Receiver sig</td>
        </tr>
