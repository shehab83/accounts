...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          ...
          @can('اضافة فاتورة خدمات داخلية وخارجية')
